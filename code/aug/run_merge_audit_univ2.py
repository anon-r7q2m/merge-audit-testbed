...
def make_packers(ctx, seed):
    ...
    for br in "AB":
        ...
        pl = univ2_slot_pattern(len(facts), K_EXP, exp_tokens,
                                "expose_slots_u2", (seed, br))
...
def main():
    ...
    ap.add_argument("--out-dir", default="results/univ2")
    ...
    for seed in SEEDS:
        ...
        for br in "AB":
            ...
            if not ctx.done(rid_d):
                pl = univ2_slot_pattern(R.N_SHARED, K_MAINT,
                                        6104 * R.TOK_PER_STEP,
                                        "drift_shared_u2", (seed, br))
                packer = R.RowPacker(R.SentenceStream(
                    "u2drift:{}:{}".format(seed, br), u["pools"]["shared"],
